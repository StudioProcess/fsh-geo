...
export function create() {
  ...
  anim.add(params.animation, 'pathAnimSpeed', 0, 0.02, 0.001).onChange(a => { mat_anim.uniforms.pathAnimSpeed.value = a; });
  anim.add(params.animation, 'pathDispSpeed', 0, 0.2, 0.001).onChange(a => { mat_anim.uniforms.pathDispSpeed.value = a; });
  anim.add(params.animation, 'pathDispFreq', 0, 0.3, 0.001).onChange(a => { mat_anim.uniforms.pathDispFreq.value = a; });
  anim.add(params.animation, 'pathDispAmp', 0, 1, 0.001).onChange(a => { mat_anim.uniforms.pathDispAmp.value = a; });
